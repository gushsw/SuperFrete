...
environment_name = 'superfrete-mwaa'
region_name = 'us-east-1'
dag_s3_path = 's3://superfrete-bucket-dados/Engenharia/ApacheAirflow/Dags'
execution_role_arn = 'arn:aws:iam::123456789012:role/SuperFreteMWAARole' #Trocar pela arn da role que que executará o MWAA
source_bucket_arn = 'arn:aws:s3:::superfrete-bucket-dados/Engenharia/ApacheAirflow'
