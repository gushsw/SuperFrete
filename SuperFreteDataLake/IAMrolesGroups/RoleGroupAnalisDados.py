...
iam.create_user(UserName='superfrete-analista-dados')
...
iam.create_role(
    RoleName='superfrete-analista-dados-role',
...
iam.add_user_to_group(UserName='superfrete-analista-dados', GroupName='superfrete-analista-dados-role')

print("Usuário e role para Analista de Dados criados com sucesso!")
