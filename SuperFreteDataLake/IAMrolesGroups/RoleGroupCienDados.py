...
iam.create_user(UserName='superfrete-cientista-dados')
...
iam.create_role(
    RoleName='superfrete-cientista-dados-role',
...
iam.add_user_to_group(UserName='superfrete-cientista-dados', GroupName='superfrete-cientista-dados-role')

print("Usuário e role para Cientista de Dados criados com sucesso!")
